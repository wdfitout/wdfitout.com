...
const DhSpa = () => {
  ...
  const imageUrls = [
    { src: "/images/dhfs (2).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/dhfs (3).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/dhfs (4).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/dhfs (5).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/dhfs (6).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/dhfs (7).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
];
      ...
      <div className="atlantis">
        <div className="flex flex-wrap justify-center">
          {imageUrls.map((image, index) => (
            <div key={index} className="w-full mb-4 sm:mb-4 relative sm:w-1/3 px-2">
              <Image
                src={image.src}
                alt={image.alt}
                title={image.title}
