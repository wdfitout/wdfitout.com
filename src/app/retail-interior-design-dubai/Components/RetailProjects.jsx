...
const RetailProjects = () => {
  ...
  <Link href="retail-interior-design-dubai/luxury-facial-studio-design-in-dubai-hills-mall">
    <Image
       src="/images/luxury-facial-studio-design-in-dubai-hills-mall.webp"
 ...
 <div className="absolute top-18 bottom-24 left-0 w-full flex items-center justify-center">
  ...
  <div className="text-white text-sm mt-2 mb-4 sm:mb-0 relative">
    <p>Feel like a Peaky Blinder in Dubai! WE DO Interior Design & Fitout made this barber shop look just like the one from the famous TV show. It's stylish and cool, with decorations that remind you of the Shelby family. WE DO make your dream space come true in Dubai. Call us today!
      ...
      <div className="w-full px-2 sm:w-1/2 mb-4 relative">
  <Link href="retail-interior-design-dubai/barber-shop-interior-design-in-palm-jumeirah-dubai">
    <Image
       src="/images/barber-shop-interior-design-in-palm-jumeirah-dubai.webp"
      alt="Residential Project"
      width={700}
      height={300}
...
<div className="w-full px-2 sm:w-1/2 mb-4 relative">
<Link href="retail-interior-design-dubai/clothing-store-premium-interior-design-in-al-wasl-dubai">
    <Image
       src="/images/clothing-store-premium-interior-design-in-al-wasl-dubai.webp"
      alt="Residential Project"
      width={700}
      height={300}
      className="w-full hover:transform hover:-translate-y-2 transition-transform duration-500"
...
<div className="w-full px-2 sm:w-1/2 mb-4 relative">
<Link href="retail-interior-design-dubai/boutique-interior-design-in-umm-suqeim-dubai">
    <Image
       src="/images/boutique-interior-design-in-umm-suqeim-dubai.webp"
      alt="Residential Project"
      width={700}
      height={300}
