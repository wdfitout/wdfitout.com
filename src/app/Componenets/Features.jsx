...
const Features = () => {
  ...
  style={{ borderTopLeftRadius: '2rem' }}
      />
<div className="absolute top-18 bottom-8 left-0 w-full flex items-center justify-center">
  <div className="flex-grow px-2">
    <h3 className="text-[#121212] text-lg font-semibold text-center bg-gray-200 bg-opacity-50 py-2 px-4 rounded  hover:text-[#c38d90] transition duration-300 ease-in-out">
