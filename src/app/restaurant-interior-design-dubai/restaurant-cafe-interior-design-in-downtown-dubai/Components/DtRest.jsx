...
const DtRest = () => {
  ...
  const imageUrls = [
    { src: "/images/dtrest (1).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/dtrest (2).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/dtrest (3).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/dtrest (4).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/dtrest (5).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/dtrest (6).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/dtrest (7).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/dtrest (8).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
